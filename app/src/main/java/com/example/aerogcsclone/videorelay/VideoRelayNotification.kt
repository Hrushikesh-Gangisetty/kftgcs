...
import com.example.aerogcsclone.MainActivity
...
object VideoRelayNotification {
    ...
    fun buildNotification(context: Context, contentText: String): Notification {
        ...
        val stopIntent = Intent(context, com.example.aerogcsclone.videorelay.VideoRelayService::class.java).apply {
            action = com.example.aerogcsclone.videorelay.VideoRelayService.ACTION_STOP
        }
